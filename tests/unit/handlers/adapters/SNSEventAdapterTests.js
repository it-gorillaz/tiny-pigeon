const { expect } = require("chai"),
      { SNSEventAdapter } = require("../../../../lib/handlers");

describe("SNSEventAdapter", () => {
  ...
  describe("#adapt()", () => {
    ...
    it("should parse message body", () => {
      ...
      const adapter = new SNSEventAdapter();
      adapter.adapt(event);

      expect(event.Records[0].Sns.Message).to.be.instanceOf(Object);
    })
