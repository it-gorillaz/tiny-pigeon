const { expect } = require("chai"),
      { SNSLogAdapter } = require("../../../../lib/logger");

describe("SNSLogAdapter", () => {

  describe("#adapt()", () => {

    it("should adapt sns attributes", () => {
      const event = {
        "Records": [
          {
            "EventSource": "aws:sns",
      ...
      const body = new SNSLogAdapter().adapt(event);
